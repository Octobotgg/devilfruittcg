...
CREATE TABLE "card_print_display_published" (
	...
	"label_status" "pricing_label_status" NOT NULL,
...
CREATE TABLE "pricing_verification_results" (
	...
	"mapping_integrity_status" "pricing_mapping_integrity_status" NOT NULL,
	"label_integrity_status" "pricing_label_status" NOT NULL,
	"verification_status" "pricing_verification_status" NOT NULL,
	"reason" text,
...
ALTER TABLE "card_print_price_published" ADD CONSTRAINT "card_print_price_published_external_variant_id_external_product_variants_id_fk" FOREIGN KEY ("external_variant_id") REFERENCES "public"."external_product_variants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
