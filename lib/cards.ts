...
const STRICT_OFFICIAL_CARDS: Card[] = (OFFICIAL_CARDS_JSON as Card[]).map(attachVariantInfo);

export const SEED_CARDS: Card[] = STRICT_OFFICIAL_CARDS.filter((card) => card.id === card.baseId);
