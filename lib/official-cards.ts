...
const LEGACY_CANONICAL_ID_ALIASES = new Map<string, string>([
  ...
  ["EB01-001_SP_EB01", "EB01-001_ALTERNATE_ART_EB01"],
  ["EB01-021_SP_EB01", "EB01-021_ALTERNATE_ART_EB01"],
  ["EB01-057_SP_EB01", "EB01-057_ALTERNATE_ART_EB01"],
  ["OP02-013_MANGA_OP02_PRINT_1", "OP02-013_PARALLEL_OP02_PRINT_1"],
  ["OP06-118_REPRINT_PRB01", "OP06-118_MANGA_PRB01"],
]);
