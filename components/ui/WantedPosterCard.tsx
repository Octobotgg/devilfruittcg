...
export default function WantedPosterCard({ id, name, subtitle, href, variant = "p1", searchId }: WantedPosterCardProps) {
  return (
    <Link href={href} className="group block wanted-poster rounded-2xl p-3">
      <p className="text-[9px] font-black uppercase tracking-[0.2em] text-[#5d4325]">Wanted</p>
      <div className="mt-1 overflow-hidden rounded-lg border border-[#8f6a3b]/40 bg-[#ecd3a4]/25">
        <img
      ...
      <p className="text-[11px] text-[#5d4325]">{subtitle || searchId || id}</p>
