...
import { OFFICIAL_BASE_CARDS, OFFICIAL_CARDS, getOfficialCardsByIds, searchOfficialCards } from "@/lib/official-cards";
...
export async function GET(req: NextRequest) {
  ...
  const filtered = filterCards(source, { set, color, rarity, type, costMin, costMax });
